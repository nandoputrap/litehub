            ...
            <div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title black-modal" id="detailModalLabel">Update Package</h4>
                        </div>
                        <div class="modal-body">
                            <form action="laman.php" method="post">
                                <div class="form-group">
                                    <label for="nama_paket">Package Name</label>
                                    <input type="text" class="form-control" id="update-packagesname" name="nama_paket" placeholder="Package Name">
                                </div>
                                <div class="form-group">
                                    <label for="tujuan">Destination</label>
                                    <input type="text" class="form-control" id="update-destination" name="tujuan" placeholder="Destination">
                                </div>
                                <div class="form-group">
                                    <label for="username">Feature</label>
                                    <input type="text" class="form-control" id="update-feature" name="fitur" placeholder="Feature">
                                </div>
                                <div class="form-group">
                                    <label for="password">Price</label>
                                    <input type="number" class="form-control" id="update-price" name="harga" placeholder="Price">
                                </div>
